    ...
    public class CompanySqlDAO : ICompanyDAO
    {
        ...
        public List<DAO.Company> GetAll()
        {
            ...
            using (var connection = _dbConnection.CreateConnection())
            {
                ...
                {
                    command.CommandText = "SELECT Company_ID, Company_Name, Contact_Email, Contact_Phone FROM Company";
        ...
        public DAO.Company GetById(int id)
        {
            using (var connection = _dbConnection.CreateConnection())
            {
                ...
                using (var command = connection.CreateCommand())
                {
                    command.CommandText = "SELECT Company_ID, Company_Name, Contact_Email, Contact_Phone FROM Company WHERE Company_ID = @Company_ID";
        ...
        public int Insert(DAO.Company company)
        {
            using (var connection = _dbConnection.CreateConnection())
            {
                ...
                using (var command = connection.CreateCommand())
                {
                    command.CommandText = @"INSERT INTO Company (Company_Name, Contact_Email, Contact_Phone) 
                                          VALUES (@Company_Name, @Contact_Email, @Contact_Phone);
            ...
            using (var connection = _dbConnection.CreateConnection())
            {
                ...
                using (var command = connection.CreateCommand())
                {
                    command.CommandText = @"UPDATE Company 
                                          SET Company_Name = @Company_Name, Contact_Email = @Contact_Email, Contact_Phone = @Contact_Phone 
        ...
        public List<DAO.Company> GetByName(string name)
        {
            ...
            using (var connection = _dbConnection.CreateConnection())
            {
                ...
                using (var command = connection.CreateCommand())
                {
                    command.CommandText = "SELECT Company_ID, Company_Name, Contact_Email, Contact_Phone FROM Company WHERE Company_Name LIKE @Company_Name";
